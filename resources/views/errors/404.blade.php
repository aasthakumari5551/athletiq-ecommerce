...
<head>
    ...
    <title>404 — Page Not Found | Athletiq</title>
...
<body class="bg-black font-sans antialiased">
    <div class="flex min-h-screen flex-col items-center justify-center px-4 text-center">
        ...
        <p class="text-sm font-black uppercase tracking-widest text-white/40">Error 404</p>
        <h1 class="mt-4 text-8xl font-black uppercase text-white sm:text-9xl">404</h1>
        <p class="mt-4 text-xl font-black uppercase text-white/70">Page not found.</p>
